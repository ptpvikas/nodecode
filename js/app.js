...
import MovieDashboard from './components/pages/MovieDashboard';
import NotFound from './components/pages/NotFound.react';
import UserProfile from './components/pages/UserProfiles.react';
import MovieProfile from './components/pages/MovieProfile.react';
    ...
    <Router history={browserHistory}>
      <Route component={App}>
        ...
        <Route onEnter={checkAuth}>
         ...
         <Route path="/films/:id" component={MovieProfile} />
         <Route path="/films/" component={MovieDashboard} />
        </Route>
