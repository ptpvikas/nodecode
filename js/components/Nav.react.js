...
class Nav extends Component {
  render() {
    ...
    const navButtons = this.props.loggedIn ? (
        ...
        <div>
          <Link to="/register" className="btn btn--login btn--nav">User Registration</Link>
    ...
    return(
      <div className="nav">
        <div className="nav__wrapper">
          <Link to="/" className="nav__logo-wrapper"><h1 className="nav__logo">Star War Website</h1></Link>
          { navButtons }
        </div>
      </div>
    );
